...
namespace DQS_STAGING_DATA_test
{
    public class OverwritedTestService : SqlDatabaseTestService
    {
        ...
        public OverwritedTestService(TestContext testContextInstance)
        {
            ...
            InitialCatalog = (string)testContextInstance.Properties["DQS_STAGING_DATA_DatabaseName"];
            ...
            sqlConnectionString = new SqlConnectionStringBuilder
            {
                ...
                DataSource = (string)testContextInstance.Properties["DQS_STAGING_DATA_ServerName"],
